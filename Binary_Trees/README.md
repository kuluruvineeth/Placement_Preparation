...
## 17. [Min swaps require to convert binary tree to BST](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Binary_Trees/min_swaps_require_to_convert_binary_tree_to_BST.cpp)
```cpp
/*
...
## 18. [Check if all leaf nodes are at same level](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Binary_Trees/check_if_all_leaf_node_are_at_same_level.cpp)
```cpp
#include <bits/stdc++.h>
using namespace std;
