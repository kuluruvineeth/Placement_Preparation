...
## 14. [Dijkstra Algorithm](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Graphs/dijkstra_algo.cpp)
```cpp
/*
...
## 15. [Kruskals Algorithm](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Graphs/kruskals_algorithm.cpp)
```cpp
/*
    E is the edges
