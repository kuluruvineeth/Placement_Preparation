...
## 13. [Merge sort linked list](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Linked_List/merge_sorted_linked_list.cpp)
```cpp
#include <bits/stdc++.h>
using namespace std;
...
## 14. [Middle element of linked list](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Linked_List/middle_element_linked_list.cpp)
```cpp
#include <bits/stdc++.h>
using namespace std;
...
## 15. [Check if linked list is circular](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Linked_List/check_if_circular_linked_list.cpp)
```cpp
#include<bits/stdc++.h>
using namespace std;
