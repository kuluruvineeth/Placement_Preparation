...
## 11. [Count inversions](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Sorting_and_Searching/count_inversions.cpp)
```cpp
#include<bits/stdc++.h>
using namespace std;
/*
...
## 12. [Kth element of two sorted arrays](https://github.com/kuluruvineeth/Placement_Preparation/blob/main/Sorting_and_Searching/kth_element_of_two_sorted_arrays.cpp)
```cpp
#include<bits/stdc++.h>
using namespace std;
